...
\begin{figure}[h]
    \centering
    \includegraphics[width=12cm]{vitamine-D-title.png}
\end{figure}
...
\end{figure}
\\
However, the body CANNOT synthetize (aka produce) vitamins by itself, EXCEPT Vitamin D which is the main focus of this paper, and vitamin K.
...
It means that, without enough Magnesium, Vitamin D is stored but not used. 50\% of American are Magnesium deficient. 
\\ \\
